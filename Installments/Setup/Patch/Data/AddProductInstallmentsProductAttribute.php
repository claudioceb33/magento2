...
class AddProductInstallmentsProductAttribute implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function apply()
    {
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'label' => 'Installments',
                'input' => 'select',
                'source' => \Ceb\Installments\Model\Product\Attribute\Source\ProductInstallments::class,
                'frontend' => '',
                'required' => false,
                'backend' => '',
                'sort_order' => '30',
    ...
    public function revert()
    {
        ...
        /** @var EavSetup $eavSetup */
        $eavSetup = $this->eavSetupFactory->create(['setup' => $this->moduleDataSetup]);
        $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'product_installments');
