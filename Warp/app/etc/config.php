...
return [
    'modules' => [
        ...
        'Demo66_Core' => 1,
        'Demo66_Swatches' => 1,
        'Ecommerce66_AiCore' => 1,
        'Ecommerce66_AiContent' => 1,
        'Ecommerce66_AiLlmSearch' => 1,
        'Ecommerce66_AiRelated' => 1,
        'Smile_ElasticsuiteCore' => 1,
        'Ecommerce66_Brands' => 1,
        'Ecommerce66_CartQuantity' => 1,
        'Ecommerce66_Checkout' => 1,
        'Ecommerce66_Core' => 1,
        'Ecommerce66_DbClean' => 1,
        'Ecommerce66_ElasticsuiteCore' => 1,
        'Hexamarvel_FlexibleForm' => 1,
        'Ecommerce66_InvoiceA' => 1,
        'Ecommerce66_MultilineDiscount' => 1,
        'Ecommerce66_OTPLogin' => 1,
        'Ecommerce66_ProductTabs' => 1,
        'Ecommerce66_PromoMassAction' => 1,
        'Mageplaza_Core' => 1,
        'Ecommerce66_Theme' => 1,
        'Ecommerce66_Widgets' => 1,
        'Ecommerce66_HexamarvelOverride' => 1,
        'Lillik_PriceDecimal' => 1,
        'Mageplaza_BackendReindex' => 1,
        'Mageplaza_TableRateShipping' => 1,
        'Mageplaza_Smtp' => 1,
        'Ecommerce66_TableRateShipping' => 1,
        'MarkShust_DisableTwoFactorAuth' => 1,
        'Mtools_Core' => 1,
        'Mtools_CronRun' => 1,
        'Mtools_SpamBlocker' => 1,
        'Mtools_TrustedEmail' => 1,
        'PayPal_Braintree' => 0,
        ...
        'Swissup_ProLabels' => 1,
        'Swissup_ProLabelsConfigurableProduct' => 1,
