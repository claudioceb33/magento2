...
use Ecommerce66\MultilineDiscount\Model\Validator;
...
class Discount extends AbstractTotal
{
    ...
    public function __construct(
        ...
        Data $jsonHelper,
        protected \Ecommerce66\MultilineDiscount\Helper\Data $dataHelper
    ) {
    ...
    private function aggregateDiscountPerRule(
        ...
        if ($discountBreakdown) {
            ...
            if ($this->dataHelper->getIsActive()) {
                ...
                $options[] = [
                    'code' => 'discounts',
                    'value' => $this->jsonHelper->jsonEncode($itemDiscounts),
