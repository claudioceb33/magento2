 ...
 */
class TabsProducts extends AbstractProduct implements BlockInterface, IdentityInterface
{
    /**
    ...
    {
        return  $this->getData('template_selector');
    }
    /**
     * @inheritdoc
    ...
    {
        $products = [];
        if ($this->getData('product_chooser_tab_1')) {
            $products['tab_1'] = $this->createCollection($this->getData('product_chooser_tab_1'));
        }
        if ($this->getData('product_chooser_tab_2')) {
            $products['tab_2'] = $this->createCollection($this->getData('product_chooser_tab_2'));
        }
        if ($this->getData('product_chooser_tab_3')) {
            $products['tab_3'] = $this->createCollection($this->getData('product_chooser_tab_3'));
        }
        if ($this->getData('product_chooser_tab_4')) {
            $products['tab_4'] = $this->createCollection($this->getData('product_chooser_tab_4'));
        }
     ...
     */
    public function createCollection($tab)
    {
