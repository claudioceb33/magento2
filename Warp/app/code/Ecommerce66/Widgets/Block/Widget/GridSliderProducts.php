 ...
 */
class GridSliderProducts extends AbstractProduct implements BlockInterface, IdentityInterface
{
    /**
    ...
    public function createCollection()
    {
        ...
        if ($this->getData('multi_product_chooser')) {
            $skus = $this->getData('multi_product_chooser');
            $skus =  explode(',', !empty($skus) ? $skus : '');
            $skus_string = "'" . str_replace(",", "','", $this->getData('multi_product_chooser')) . "'";
