define([
    ...
    function getSection(){
        return '.ecommerce66-invoicea-fields';
    }
    ...
    $checkout.on('change','select[name="customer_tax_situation"]',function (el){
        setTimeout(function(){
            ...
            if (selected === '0' || selected === '') {
                $('div[name="ecommerce66CustomInvoiceA.customer_cuit"]').removeClass('_required');
                $form.find('input[name="customer_cuit"]').closest('.field').fadeOut();
                $form.find('input[name="customer_cuit"]').removeClass('validate-facturaa');
                $('div[name="ecommerce66CustomInvoiceA.customer_company"]').removeClass('_required');
                ...
                $('div[name="ecommerce66CustomInvoiceA.customer_cuit"]').addClass('_required');
                $form.find('input[name="customer_cuit"]').closest('.field').fadeIn();
                $form.find('input[name="customer_cuit"]').addClass('validate-facturaa');
                $('div[name="ecommerce66CustomInvoiceA.customer_company"]').addClass('_required');
