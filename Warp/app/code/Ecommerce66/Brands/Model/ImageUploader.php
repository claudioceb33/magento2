...
class ImageUploader
{
    ...
    public function __construct(
        ...
        $allowedExtensions = ['gif','png','jpg','jpeg','svg','pdf'],
        $baseTmpPath = 'e66/tmp/brands',
        $basePath = 'e66/brands',
        $allowedMimeTypes = ['image/gif','image/jpeg','image/png','image/svg+xml','image/webp'],
        ...
        //$this->baseTmpPath = 'e66/tmp/brands';
        //$this->basePath = 'e66/brands';
    }
     ...
     */
    public function moveFileFromTmp($imageName, $returnRelativePath = null)
    {
        $basePath = $this->getBasePath();
        $baseTmpPath = $this->getBaseTmpPath();
        $returnRelativePath = !empty($returnRelativePath) ? $returnRelativePath : false;
    ...
    public function saveFileToTmpDir($fileId)
    {
        ...
        if (isset($result['file'])) {
            try {
                $baseTmpPath = empty($baseTmpPath) ? '' : $baseTmpPath;
